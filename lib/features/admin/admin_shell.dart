...
class AdminShell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int currentIndex = 0;
    if (location.startsWith('/admin/shared-goals')) {
      currentIndex = 1;
    } else if (location.startsWith('/admin/analytics')) {
      currentIndex = 2;
    } else if (location.startsWith('/admin/cycles')) {
      currentIndex = 3;
    } else if (location.startsWith('/admin/org')) {
      currentIndex = 4;
    } else if (location.startsWith('/admin/audit')) {
      currentIndex = 5;
    } else if (location.startsWith('/admin/unlock')) {
      currentIndex = 6;
    } else if (location.startsWith('/admin/report')) {
      currentIndex = 7;
